...
if ( ! function_exists( 'academist_elated_loading_spinner_academist' ) ) {
   ...
   <g>
	   <path class="eltdf-checkmark-svg-path-1" fill="#7F3E98" d="M11.929,47.489c-0.016,0.208,0.291,0.397,0.617,0.532c0.308-0.099,0.615-0.206,0.917-0.326
	   ...
	   <path class="eltdf-checkmark-svg-path-2" fill="#7F3E98" d="M59.983,0.002c-0.058-0.052-1.246,0.729-1.303,0.764c-0.603,0.353-6.72,4.257-7.037,4.489
