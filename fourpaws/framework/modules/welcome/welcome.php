...
if ( ! class_exists( 'AcademistElatedWelcomePage' ) ) {
	class AcademistElatedWelcomePage {
		/**
		 * singleton class
		 */
		...
		/**
		 * get the instance of AcademistWelcomePage
		 *
		 * @return self
		 */
		...
		function welcome_page_content() {
			...
			echo academist_elated_get_module_template_part( 'templates/welcome', 'welcome', '', $params );
		}
		...
		function enqueue_styles( $hook ) {
			if ( $hook === 'appearance_page_academist_elated_welcome_page' ) {
				wp_enqueue_style( 'academist-elated-welcome-page-style', ELATED_FRAMEWORK_MODULES_ROOT . '/welcome/assets/admin/css/welcome.min.css' );
			}
		}
	}
}

AcademistElatedWelcomePage::get_instance();